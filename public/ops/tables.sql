...
ALTER TABLE order_header ADD card_name VARCHAR(120) NOT NULL;
UPDATE order_header SET card_name = name;
...
SELECT b.id, b.breed_name AS breed, b.breed_class_code AS class_code, bc.class AS breed_class, b.breed_is_standard
FROM breeds b, breeds_class bc
WHERE bc.code = b.breed_class_code
ORDER BY bc.class, b.breed_name
...
ALTER TABLE breeds ADD weight_unit VARCHAR(12) NOT NULL;
UPDATE breeds SET weight_unit = 'lb';

ALTER TABLE breeds ADD breed_is_standard char(1) NOT NULL  DEFAULT 'Y';
UPDATE breeds SET breed_is_standard = 'Y';
...
CREATE TABLE contest_entries (
     ...
     breed_id         INT   NULL, /* NULL means OTHER */
     user_filename    VARCHAR(250) NULL,
     hash             VARCHAR(80)  NULL, /* null until id is assigned */
     file_ext         VARCHAR(24)  NOT NULL,
     web_path         VARCHAR(200) NULL,
